  ...
  return (
    <div className="space-y-8 fade-in">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-2">Risk Management Dashboard</h1>
          <p className="text-slate-600 dark:text-slate-400">Monitor and analyze your organization's risk landscape</p>
        </div>
        <div className="text-right">
          <div className="text-sm text-slate-500 dark:text-slate-400">Last updated</div>
          <div className="text-lg font-semibold text-slate-700 dark:text-slate-300">{new Date().toLocaleDateString()}</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card p-6 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <div className="text-sm text-slate-500 dark:text-slate-400">Total Risks</div>
            </div>
          </div>
        ...
        <div className="card p-6 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <div className="text-2xl font-bold text-slate-900 dark:text-white">{mostCommonRiskLevel}</div>
              <div className="text-sm text-slate-500 dark:text-slate-400">Most Common Level</div>
            </div>
          </div>
        ...
        <div className="card p-6 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <div className="text-2xl font-bold text-slate-900 dark:text-white">{mostCommonTreatment}</div>
              <div className="text-sm text-slate-500 dark:text-slate-400">Common Treatment</div>
            </div>
          </div>
